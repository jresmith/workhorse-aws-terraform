...
variable "vpc_cidr" {
  type        = string
  description = "Entire Production environment cidr"
}

variable "public_subnet_cidrs" {
  type        = list(string)
  description = "Subnets to be used for Public ranges in Production env - to be used across multiple AZs"
}

variable "private_subnet_cidrs" {
  type        = list(string)
  description = "Subnets to be used for Private ranges in Production env - to be used across multiple AZs"
}

variable "azs" {
  type        = list(string)
  description = "List of AZs to be used within Production env"
}
