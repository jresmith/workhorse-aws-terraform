...
| kubeseal --cert workhorse/gitops/addons/sealed-secrets/public-certs/dev.crt --format yaml < workhorse/gitops/cluster/staging/argocd/config/repo-pat.yaml  | How to seal (encrypt) k8s secret using Dev Env Public key |